...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../sm/css/thems.css">
    <script type="text/javascript" src="../sm/js/jquery-1.8.3.min.js"></script>
    <!--框架高度设置-->
...
<!--登录-->
<div class="login">
    <div class="bg_img"><img src="../sm//images/login_bg.jpg"/></div>
    <div class="logo">
        <a href=""><img src="../sm//images/logo.png" alt=""/></a>
    </div>
    <div class="login_m">
